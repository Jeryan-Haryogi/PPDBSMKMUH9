                ...
                <main>
                    ...
                    <div class="container mt-n10">
                         <div class="card card-icon mb-4">
                            <div class="row no-gutters">
                                <div class="col-sm-6  " style="margin-top: 90px;">
                                    <h1 class="m-4"><b>Data Peserta Didik PPDB Online Yang Terkonfirmasi</b></h1>
                                  <h1 class="m-4"><?= date('Y') ?>/ <?= date('Y', strtotime('+1 year')) ?></h1>
                                </div>
                                <div class="col-sm-6 mt-5">
                                  
                                  <img src="{{url('admin/assets/img')}}/target.jpg" width="70%">
                                </div>
                            </div>
                        </div>
                    </div>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="datatable">
                                    <a href="{{url('Administrator/ppdb/export-data-konfirmasi')}}" class="btn btn-primary">EXPORT</a>
                                   <table id="users-list-datatable" class="table mt-3">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama Lengkap</th>
                            ...
                            <tbody>
                              ...
                              <?php foreach ($data as $key => $value): ?>
                                ...
                                <tr>
                                    ...
                                    <form action="{{url('Administrator/ppdb/peserta-didik-baru-terkonfirmasi/')}}/<?= date('Y')?>-<?= date('Y',strtotime('+1 year')) ?>/<?= $value->id_peserta_didik ?>" method="post">
                                      @csrf
                                      @method('delete')
